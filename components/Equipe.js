...
const MEMBERS = [
  ...
  },
  {
    ...
    avatar: '/images/team/daniel-slaver-mbengui.jpeg', color: '#1565D8', bg: '#EAF2FF',
  },
  {
    categoryIdx: 1,
    ...
    avatar: '/images/team/willy-kiwa.jpeg', color: '#0D47A1', bg: '#E3F2FD',
  },
  {
    categoryIdx: 1,
    ...
    avatar: '/images/team/afonso-nhanga.jpeg', color: '#1565D8', bg: '#EAF2FF',
  },
  {
    categoryIdx: 2,
    name: 'Luis ANDRÉ DE CARVALHO', initials: 'LADC',
    roleKey: { fr: 'Coordinateur de formation', pt: 'Coordenadora de formação', en: 'Training Coordinator' },
    ...
    avatar: '/images/team/luis-andre-de-carvalho.jpeg', color: '#1565D8', bg: '#EAF2FF',
  },
  {
    categoryIdx: 2,
  ...
  },
  {
    ...
    avatar: '/images/team/edna.jpeg', color: '#1565D8', bg: '#EAF2FF',
  },
  {
    categoryIdx: 4,
    ...
    avatar: '/images/team/abelardo-panzo-moises.jpeg', color: '#4CAF50', bg: '#E8F5E9',
  },
  {
    categoryIdx: 4,
    ...
    avatar: '/images/team/filipe-nsiangani.jpeg', color: '#4CAF50', bg: '#E8F5E9',
  },
  {
    categoryIdx: 4,
    ...
    roleKey: { fr: 'Agent de sécurité', pt: 'Agente de segurança', en: 'Security Officer' },
    descKey: { fr: "Veille à la sécurité des lieux et des personnes au quotidien.", pt: "Garante a segurança das instalações e das pessoas diariamente.", en: "Ensures the daily safety of the premises and people." },
    avatar: '/images/team/jordao-jose.jpeg', color: '#4CAF50', bg: '#E8F5E9',
  },
  {
    categoryIdx: 4,
    ...
    avatar: '/images/team/amelia-antonica-pedro-gomes.jpeg', color: '#4CAF50', bg: '#E8F5E9',
  },
]
